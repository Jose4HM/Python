...
os.system('cls')
def clean():
    archivo = 'C:/Users/User/Desktop/Codes/DataBase/Horarios2021.xlsx'
    read_file = pd.DataFrame(pd.read_excel(archivo))
    read_file.to_csv('C:/Users/User/Desktop/Codes/DataBase/fileexcelhorarios(NoBorrar).csv',index = None, header=True)
    df = pd.DataFrame(pd.read_csv('C:/Users/User/Desktop/Codes/DataBase/fileexcelhorarios(NoBorrar).csv'))
    ...
    final.to_csv('C:/Users/User/Desktop/Codes/DataBase/horarios/subjects.csv',index=False)
    df=pd.DataFrame(pd.read_csv('C:/Users/User/Desktop/Codes/DataBase/horarios/subjects.csv'))
...
def extract(data):
    ...
    for i in range(0,len(subjects)):
        ...
        csv.to_csv('C:/Users/User/Desktop/Codes/DataBase/horarios/CursosOnebyOne/subject{}.csv'.format(i+1),index=False)
    number=len(subjects)
    readall(number)
...
def readall(n):
    ...
    df=(pd.read_csv('C:/Users/User/Desktop/Codes/DataBase/horarios/CursosOnebyOne/subject1.csv'))
